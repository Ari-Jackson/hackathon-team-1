const Ari = () => {
    return (
        <p className="w-[80%] mx-auto mt-24 text-center ">
            ...
            empowering. I thoroughly enjoyed building more and more databases and
            pages to enable both myself and others to accomplish more. As my
            systems expanded, so did my desire to share them with a wider audience.
            This motivated me to enroll in Pursuit to elevate my web development
