const Taylor = () => {
    return (
        <p className="w-[80%] mx-auto mt-24 text-center">
            ...
            <br /> <br />
            <a className="text-[#0065ff] font-bold" href="https://github.com/taylorbrooks007" target="_blank" rel="noreferrer">
                GitHub Link
            </a>

            <a className="text-[#0065ff] font-bold" href="https://www.linkedin.com/in/taylorybrooks/" target="_blank" rel="noreferrer">
                LinkedIn
            </a>
