      ...
      <div className="h-screen">
        <div className=" mx-auto mt-[10%] rounded-lg shadow-md bg-white w-[30%] h-[60%] flex grid  p-12 ">
          ...
          <button
            ...
            className="  mx-auto w-[25%] h-[60%] relative rounded px-1 py-1 overflow-hidden group bg-green-500 relative hover:bg-gradient-to-r hover:from-green-500 hover:to-green-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-green-400 transition-all ease-out duration-300"
          >
